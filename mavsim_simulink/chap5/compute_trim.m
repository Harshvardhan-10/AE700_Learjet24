...
% Va    = 80;           % desired airspeed   [m/s]  (Learjet 24 cruise)
% 
% % n     = 1.2;    % load factor
% n = 1;
% 
...
gamma = 0;
Va    = 80;       % FIX: was 170 m/s — that gives alpha ≈ 0.2 deg (wrong)
...
u0 = [0; 0; 0; 0.5];
iu = [2; 3];               % hold delta_a = 0, delta_r = 0

y0 = [Va; 0; 0];
iy = [1; 3];               % fix Va and beta=0
...
if alpha_trim*180/pi < 5 || alpha_trim*180/pi > 7
    warning('alpha = %.2f deg is outside 5-7 deg. Adjust Va between 72-83 m/s.', ...
            alpha_trim*180/pi);
end
