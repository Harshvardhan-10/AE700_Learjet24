...
function [sys,x0,str,ts,simStateCompliance] = mdlInitializeSizes(MAV)
    ...
    sizes = simsizes;
    sizes.NumContStates  = 12;   % 12 Euler states
...
function sys = mdlOutputs(t, x, u)
    % Outputs are the 12 states directly
    sys = x;
end
